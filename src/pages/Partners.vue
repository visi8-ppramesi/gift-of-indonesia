<template>
  <div style="background-color: #202424" class="text-white pb-16">
    <div class="flex flex-row">
      ...
      >
        ...
        <div class="text-left pb-16">
          <div class="mx-6 font-bold text-xl md:text-4xl">Our Partners</div>
    ...
    <title-separator class="my-12">Our Partners</title-separator>
...
export default {
  ...
  data() {
    return {
      placeholder: require("../assets/placeholder-logo.png"),
